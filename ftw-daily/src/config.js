...
const siteTitle = 'Electively';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = 'https://twitter.com/LiveElectively';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/liveelectively/';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/Electively-103363204708498/?view_public_for=103363204708498';
