...
/* amenitiesFilterElement will go in that big blank space in the this.state.isFitlersOpenMobiel thing right above this line. Couldnt cOMMENT It out so delteed it. Replace if shit breaks */
