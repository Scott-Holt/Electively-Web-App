...
class SearchFiltersPanelComponent extends Component {
  ...
  //amenitiesFilter will go after categoryFilter in render() below if shit breaks. 
  //had to delete it. Couldn't comment it out
  ...
  render() {
    ...
    // amenitiesFilterElement  will go under the categorFilterElement in the open space below here
    return (
